...
Vue.component('products-component', require('./components/product/ProductComponent.vue').default);
...
Vue.component('product-shopping-component', require('./components/shopping_cart/ProductShoppingCartComponent.vue').default); 
